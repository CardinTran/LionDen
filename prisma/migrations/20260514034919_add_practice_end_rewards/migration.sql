...
INSERT INTO "new_PracticeCheckIn" ("attendanceStatus", "checkedInAt", "displayName", "guildId", "id", "rsvpStatus", "sessionId", "updatedAt", "userId") SELECT "attendanceStatus", "checkedInAt", "displayName", "guildId", "id", "rsvpStatus", "sessionId", "updatedAt", "userId" FROM "PracticeCheckIn";
